...
"[project]/node_modules/@zerodev/webauthn-key/_esm/utils.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function parseAndNormalizeSig(derSig) {
    const parsedSignature = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p256"].Signature.fromDER(derSig.slice(2));
    const bSig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toBytes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexToBytes"])(`0x${parsedSignature.toCompactHex()}`);
    ...
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$fromBytes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bytesToBigInt"])(bR);
    let s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$fromBytes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bytesToBigInt"])(bS);
...
"[project]/node_modules/@zerodev/webauthn-key/_esm/toWebAuthnKey.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zerodev/webauthn-key/_esm/utils.js [app-ssr] (ecmascript)");
;
;
var WebAuthnMode;
...
const encodeWebAuthnPubKey = (pubKey)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$data$2f$concat$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["concatHex"])([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(pubKey.pubX, {
            size: 32
        }),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toHex"])(pubKey.pubY, {
            size: 32
        }),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$data$2f$pad$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pad"])(pubKey.authenticatorIdHash, {
            size: 32
        })
    ]);
};
const toWebAuthnKey = async ({ webAuthnKey, rpID, passkeyName, passkeyServerUrl, mode = WebAuthnMode.Register, credentials = "include", passkeyServerHeaders = {} })=>{
    ...
    if (mode === WebAuthnMode.Login) {
        ...
        const { startAuthentication } = await __turbopack_context__.r("[project]/node_modules/@simplewebauthn/browser/dist/bundle/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        ...
        // Start registration
        const { startRegistration } = await __turbopack_context__.r("[project]/node_modules/@simplewebauthn/browser/dist/bundle/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    const authenticatorIdHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$hash$2f$keccak256$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["keccak256"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b64ToBytes"])(authenticatorId)));
...
"[project]/node_modules/@zerodev/passkey-validator/_esm/index.js [app-ssr] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
const getValidatorAddress = (entryPoint, kernelVersion, validatorContractVersion, validatorAddress)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$sdk$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateKernelVersionWithEntryPoint"])(entryPoint.version, kernelVersion);
    const passKeyValidatorAddress = Object.entries(kernelVersionRangeToContractVersionToValidator).find(([range])=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$sdk$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["satisfiesRange"])(kernelVersion, range))?.[1]?.[validatorContractVersion];
    if (!passKeyValidatorAddress && !validatorAddress) {
        throw new Error(`Validator not found for Kernel version: ${kernelVersion}`);
    }
    return validatorAddress ?? passKeyValidatorAddress ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$constants$2f$address$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["zeroAddress"];
}; //# sourceMappingURL=index.js.map
}}),
"[project]/node_modules/@zerodev/passkey-validator/_esm/toPasskeyValidator.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$passkey$2d$validator$2f$_esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@zerodev/passkey-validator/_esm/index.js [app-ssr] (ecmascript) <locals>");
;
;
;
;
...
const signMessageUsingWebAuthn = async (message, chainId, allowCredentials)=>{
    ...
    const challenge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["base64FromUint8Array"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexStringToUint8Array"])(formattedMessage), true);
    ...
    const authenticatorDataHex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b64ToBytes"])(authenticatorData));
    // get client data JSON
    const clientDataJSON = atob(cred.response.clientDataJSON);
    // get challenge and response type location
    const { beforeType } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findQuoteIndices"])(clientDataJSON);
    // get signature r,s
    const { signature } = cred.response;
    const signatureHex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uint8ArrayToHexString"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b64ToBytes"])(signature));
    const { r, s } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseAndNormalizeSig"])(signatureHex);
    // encode signature
    const encodedSignature = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$encodeAbiParameters$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encodeAbiParameters"])([
        ...
        BigInt(r),
        BigInt(s),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isRIP7212SupportedNetwork"])(chainId)
    ]);
...
async function toPasskeyValidator(client, { webAuthnKey, entryPoint, kernelVersion, validatorContractVersion, validatorAddress: _validatorAddress }) {
    const validatorAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$passkey$2d$validator$2f$_esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getValidatorAddress"])(entryPoint, kernelVersion, validatorContractVersion, _validatorAddress);
    // Fetch chain id
    const chainId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$actions$2f$public$2f$getChainId$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getChainId"])(client);
    const account = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$accounts$2f$toAccount$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toAccount"])({
        ...
        async signTypedData (typedData) {
            ...
            const hash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$signature$2f$hashTypedData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hashTypedData"])(typedData);
    ...
    return {
        ...
        getSerializedData () {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zerodev$2f$webauthn$2d$key$2f$_esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serializePasskeyValidatorData"])({
                entryPoint,
                validatorAddress,
...
//# sourceMappingURL=node_modules_894d11e8._.js.map